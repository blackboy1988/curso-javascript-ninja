(function() {
    ...
    */
    ...
    var fullName = 'heliton-oliveira-da-silva';
    ...
    function formatName( arr ) {
        ...
        for( var i = 0; i < text.length; i++ ) {
            newText.push( text[i].charAt(0).toUpperCase().concat( text[i].substring(1) ) );
        }
        return newText.join(' ');
    }
    ...
    */
    console.log( '\nMeus amigos:' );
    var friends = [ 'João','Maria','Patrícia','Roberto','Marcos' ];
    
    function formatName2( arr ) {
