(function() {
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/, 'Heliton Oliveira da Silva' ) );
    ...
    */
    ...
    console.log( text.replace( /brasileiro/g, 'carióca' ) );
    ...
    */
    ...
    console.log( text.replace(/o centauro de luvas/gi, function(captura) {
